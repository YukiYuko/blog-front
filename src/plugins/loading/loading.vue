<template>
  <div class="yuki-loading" v-show="show">
    <div class="yuki-loading-mask"></div>
    <div class="yuki-loading-content">
      <!-- / 1 -->
      <section v-if="type === 'sk-rotating-plane'">
        <div class="sk-rotating-plane"></div>
      </section>
      <!-- / 2 -->
      <section v-if="type === 'sk-double-bounce'">
      ...
      <!-- / 4 -->
      <section v-if="type === 'sk-wandering-cubes'">
      ...
      <!-- / 5 -->
      <section v-if="type === 'sk-spinner'">
        <div class="sk-spinner sk-spinner-pulse"></div>
      </section>
      <!-- / 6 -->
      <section v-if="type === 'sk-chasing-dots'">
      ...
      <!-- / 7 -->
      <section v-if="type === 'sk-three-bounce'">
      ...
      <!-- / 8 -->
      <section v-if="type === 'sk-circle-bounce'">
      ...
      <!-- / 9 -->
      <section v-if="type === 'sk-cube-grid'">
      ...
      <!-- / 10 -->
      <section v-if="type === 'sk-fading-circle'">
      ...
      <!-- / 11 -->
      <section v-if="type === 'sk-folding-cube'">
      ...
      <div class="yuki-loading-content-text">{{ text }}</div>
    </div>
  </div>
</template>
